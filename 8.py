...
def makeNewQuestion(wrongAnimal):
  ...
  newQuestion = askQuestion("Enter a question that would make it diffrent %s from %s:"
      % (definiteNoun(correctAnimal), definiteNoun(wrongAnimal))).capitalize()

  yesAnswer = answeredYes(askQuestion("If next time we play and I asked you this question " +
    "and you thought about %s, what would the correct answer be according to you?" % definiteNoun(correctAnimal)))
